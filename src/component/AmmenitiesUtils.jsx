...
function AmmenitiesUtils({ammenities}) {
  return (
    <Box sx={{alignItems:'center',display:'flex',width:'370px',height:'32px',justifyContent:'space-between',padding:'15px',backgroundColor:'red',borderRadius:'5px',backgroundColor:ammenities.color}}>
